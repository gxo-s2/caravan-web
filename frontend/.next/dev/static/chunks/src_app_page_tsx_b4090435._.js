...
const HostDashboard = ({ user })=>{
    ...
    const fetchReservations = async ()=>{
        setLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`https://caravan-app-api.onrender.com/api/reservations/host/${user.id}`);
    ...
    const handleUpdateStatus = async (id, status)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].patch(`https://caravan-app-api.onrender.com/api/reservations/${id}/status`, {
                status
            });
